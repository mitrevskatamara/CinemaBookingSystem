...
using CinemaBookingSystem.Domain;
using CinemaBookingSystem.Domain.Idenitity;
using CinemaBookingSystem.Repository;
using CinemaBookingSystem.Repository.Implementation;
using CinemaBookingSystem.Repository.Interface;
using CinemaBookingSystem.Services;
using CinemaBookingSystem.Services.Implementation;
...
namespace CinemaBookingSystem.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<CinemaBookingSystemApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
